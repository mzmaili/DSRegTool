...
if ($AADJ -ne "YES"){
    ...
    ''
    ''
    Write-Host "Script completed successfully. You can start hybrid Azure AD registration process by running 'dsregcmd /join' command as admin." -ForegroundColor Green -BackgroundColor Black
    ''
    exit
